...
| Entrevistador(es) | Entrevistado(s) | Horário de Início | Horário de Fim |    Data    |    Local     |
| :----------------: | :-------------: | :---------------: | :------------: | :--------: | :----------: |
| Caio Braga | Pedro Vitor  |   16:00    |  16:30   | 03/12/2023 | AiLab (UnB) |
...
| ID | Enunciado| Resposta| Justificativa |
| :---: | :----------------------------------------------------------: | :-----------------:|:------------|
|   1   |   A interface apresentada foi de fácil utilização?        |    Sim    | O usuária achou  a interface intuitiva e agradável |
|   2   |  A realização da tarefa solicitada trouxe algum contratempo?   |      Não     | |
|   3   |  A disposição dos elementos da tela foi agradável? |      Sim     | O usuário deu esse retorno ao protótipo |
|   4   |  A realização da tarefa solicitada corresponde a expectativa que foi criada ao ser concedida a ideia?  |      Sim      |  |
|   5   |  Foi encontrada algum erro ou inconsistência durante o uso da interface?   |        Não     |  O usuário elogiou a nova interface  |
<div style="text-align: center">
    <p> <b>Tabela 11</b>: tabela de perguntas ao Usuário (Fonte: BRAGA, Caio; 2023).</p>
</div>
...
O usuário nos ajudou a encontrar possíveis melhorias nos desenhos dos botões, algo que pode ou não ser acrescentado na interface, uma vez que se trata de uma questão de gosto pessoal. Fora isso, nenhum outro problema foi encontrado.

### **Recomendações de melhoria**

O usuário apenas recomendou as mudanças no desenho do botão.


### **Opiniões dos usuários**

O usuário achou a interface agradável e de fácil aprendizado, uma vez que as fontes estão com boa visibilidade e os ícones trazem uma boa noção das funcionalidades para o usuário.
...
- O usuário entendeu facilmente como utilizar de maneira eficaz a interface, não obtendo erros.
### **Sugestão de reprojeto para o sistema**

Para o reprojeto, é sugerido analisar se a mudança nos formatos dos botões da página do Painel Lattes realmente agregaria uma mudança visual que contribuiria para a aplicação.

### **Entrevista com o Usuário**

<iframe width="560" height="315" src="https://www.youtube.com/embed/t68cBVv9DTc?si=06asHM8NFCIQenMd" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
