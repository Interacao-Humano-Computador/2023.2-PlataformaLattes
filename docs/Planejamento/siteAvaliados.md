...
- *Interface ultrapassada*: Foi analisado que a parte visual do site é ultrapassada e pode ser reavida por uma reformulação visual para atender aos usuários.
