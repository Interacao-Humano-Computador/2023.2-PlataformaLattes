...
| Cronograma Executado | Início: 09/11 <br> Fim: 15/11 | Início: 15/11 <br> Fim:15/11 | Miguel de Frias | Doan FIlho |
| Correções da Entrega 5 | Início: 09/11 <br> Fim: 15/11 | Início: 15/11 <br> Fim:15/11 |  Caio Braga, Caio Lelis, <br> Doan Filho, Gabriel Barbosa, <br> Guilherme Basilio, Joel Soares <br> e Miguel de Frias |Caio Braga, Caio Lelis, <br> Doan Filho, Gabriel Barbosa, <br> Guilherme Basilio, Joel Soares <br> e Miguel de Frias|
...
### **Ferramentas** 
|Logo| Ferramenta | Objetivo| Etapas |
|:---:|:---:|---| --- |
|<img src = "../assets/mkdocs.png" width = 170px>|Mkdocs|Ferramenta usada para a criação do documento| Todas as etapas|
|<img src = "../assets/teams-logo.png" width = 150px>|Microsoft Teams|Aplicativo usado para fazer as reuniões e realizar as gravações| Todas as etapas |
|<img src = "../assets/vscode.png" width = 100px>|Visual Studio Code |Aplicativo/ IDE usado para a codificação da documentação| Todas as etapas |
|<img src = "../assets/telegram.png" width = 150px >|Telegram |Aplicativo para a comunicação entre os participantes| Todas as Etapas|
|<img src = "../assets/thispersona.png" width = 150px>|This person does not exist | Ferramenta para gerar pessoas ficticias| Etapa 2 (Artefato Cenários)|
|<img src = "../assets/youtube.png" width = 150px>|YouTube|Aplicativo para postar os vídeos| Todas as Etapas |
|<img src = "../assets/github.png" width = 150px>|GitHub|Ferramenta para fazer o versionamento dos códigos| Todas as Etapas |
|<img src = "../assets/sheets_icon.png" width = 150px>|Google Sheets|Ferramenta de criação de planilhas| Etapa de Verificação (Artefatos Checklists)|
