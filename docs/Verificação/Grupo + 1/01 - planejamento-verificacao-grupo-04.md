# **Planejamento de Verificação das Etapas**
...
Neste contexto, este documento realizará a avaliação das entregas efetuadas pelo [Grupo 4](https://interacao-humano-computador.github.io/2023.2-Dominio-Publico/) no desenvolvimento do site Domínio Público, no âmbito da disciplina de Interação Humano-Computador.
